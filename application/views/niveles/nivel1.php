...
<html>
    ...
    <script>
        ...
        var calendar    = new FullCalendar.Calendar(calendarEl, {
            ...
            events:     myBase_url+"index.php/Nivel1/listarTodasClasesNivel1",
            editable:   true,
            /* Funcion para cuando le den click a una fecha */
            dateClick: function(info){
            $.ajax({
                url:    myBase_url+"index.php/Nivel1/GetDataNivel1",
                type:   'POST',
                async:  true,
            ...
            eventDrop: function(info){
                ...
                const url           = myBase_url+"index.php/Nivel1/drop";
        ...
        frm.addEventListener('submit',function(e) {
            ...
            if(alumno == "" || hora_clase == "" || fecha_clase == "" || maestro == "" || nivel == "" || color == ""){
                ...
                const url = myBase_url+"index.php/Nivel1/registrar";
                const http = new XMLHttpRequest();
                http.open('POST',url,true);
        ...
        eliminar.addEventListener('click',function(){
            ...
            function(isConfirm){
                if(isConfirm){
                    ...
                    const url   = myBase_url+"index.php/Nivel1/eliminar/"+id;
                    const http  = new XMLHttpRequest();
                        ...
                        <div class="panel panel-border panel-info">                                    
                            ...
                            <div class="table-responsive">                                    
                                <div class="panel-body">
                                    ...
                                    <div align="center">
                                        <input align="center" type="button" value="Generar PDF" id="botonPDF" class="btn btn-info" onclick="Nivel1Activos();"/>
                                    </div>
                                </div>
                            </div>
                        </div>

  ...
  <script>
    $(document).ready(function(){
      ...
      var calendar    = new FullCalendar.Calendar(calendarEl, {
        ...
        events:    myBase_url+"index.php/Calendario/listarClasesDelNino",
        editable:  true,
        ...
        eventClick: function(info){
          ...
          document.getElementById('hora_clase').value = info.event.title;
        ...
        eventDrop: function(info){
          ...
          const url         = myBase_url+"index.php/Calendario/drop";
      ...
      frm.addEventListener('submit',function(e) {
        ...
        if(alumno == "" || hora_clase == "" || fecha_clase == "" || maestro == "" || nivel == "" || color == ""){
          ...
          const url  = myBase_url+"index.php/Calendario/registrar";
          const http = new XMLHttpRequest();
      ...
      eliminar.addEventListener('click',function(){
        ...
        function(isConfirm){
          if(isConfirm){
            ...
            const url = myBase_url+"index.php/Calendario/eliminar/"+id;
            const http = new XMLHttpRequest();
              ...
              <div class="panel-body">
                <?php foreach($calendarios as $cal):?>
                  <div class="card" >
                    <div class="card-body">
                      <tr>
                          <h3 class="panel-title text-center">Nivel: <?=$cal->nivel?> </h3>
                      </tr>
                    </div>
                  </div>
                <?php endforeach;?>

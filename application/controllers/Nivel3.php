...
class Nivel3 extends MY_Controller {        
    ...
    public function index(){
        ...
        $data['data']        = $this->Query_Model->listarClasesAgendadasNivel3();
        $data['maestro']     = $this->Query_Model->DataMaestrosNivel3();
        
        $this->loadpageintotemplate($data);
   	}    
    public function listarTodasClasesNivel3(){
        $data = $this->Query_Model->listarClasesAgendadasNivel3();
        echo json_encode($data,JSON_UNESCAPED_UNICODE);
        die();
    }
    /* Obtener toda la información de los alumnos pertenecientes al nivel 3 */
    public function GetDataNivel3(){
        $res = $this->Query_Model->listarClasesAgendadasNivel3();

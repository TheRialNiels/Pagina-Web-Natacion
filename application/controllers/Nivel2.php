...
class Nivel2 extends MY_Controller {        
    ...
    public function index(){
        ...
        $data['data']        = $this->Query_Model->listarClasesAgendadasNivel2();
        $data['maestro']     = $this->Query_Model->DataMaestrosNivel2();
        
        $this->loadpageintotemplate($data);
   	}
    public function listarTodasClasesNivel2(){
        $data = $this->Query_Model->listarClasesAgendadasNivel2();
        echo json_encode($data,JSON_UNESCAPED_UNICODE);
        die();
    }
    /* Obtener toda la información de los alumnos pertenecientes al nivel 2 */
    public function GetDataNivel2(){
        $res = $this->Query_Model->listarClasesAgendadasNivel2();

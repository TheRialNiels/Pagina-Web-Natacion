    ...
    <script>
        $(document).ready(function(){
            ...
            var calendar    = new FullCalendar.Calendar(calendarEl, {
                ...
                events:   myBase_url+"index.php/Nivel3/listarTodasClasesNivel3",
                editable: true,
                /* Funcion para cuando le den click a una fecha */
                dateClick: function(info){
                    $.ajax({
                        url:    myBase_url+"index.php/Nivel3/GetDataNivel3",
                        type:   'POST',
                        async:  true,
                ...
                eventDrop: function(info){
                    ...
                    const url           = myBase_url+"index.php/Nivel3/drop";
            ...
            frm.addEventListener('submit',function(e) {
                ...
                if(alumno == "" || hora_clase == "" || fecha_clase == "" || maestro == "" || nivel == "" || color == ""){
                    ...
                    const url  = myBase_url+"index.php/Nivel3/registrar";
                    const http = new XMLHttpRequest();
            ...
            eliminar.addEventListener('click',function(){
                ...
                function(isConfirm){
                    if(isConfirm){
                        ...
                        const url  = myBase_url+"index.php/Nivel3/eliminar/"+id;
                        const http = new XMLHttpRequest();
                        ...
                        <div class="panel panel-border panel-info">                                    
                            ...
                            <div class="table-responsive">                                    
                                <div class="panel-body">
                                    <p class="page-text" >Las natación para una competencia requiere de un entrenamiento constante que desarrolle la fuerza y la velocidad; 
                                        ya sea para un triatlón de atletas infantiles, juveniles o másteres, se requiere de un entrenador profesional que brinde una rutina 
                                        de ejercicios que sean variados y de gran intensidad. El entrenador será el encargado de supervisar los resultados obtenidos para 
                                        cambiar o mejorar las rutinas y alcanzar los objetivos del equipo.
                                    </p>
                                    <br>
                                    ...
                                    <div align="center">
                                        <input align="center" type="button" value="Generar PDF" id="botonPDF" class="btn btn-info" onclick="Nivel3Activos();"/>
                                    </div>
                                </div>
                            </div>
                        </div>
